...
class _AnalysisScreenState extends ConsumerState<AnalysisScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _showMetricExplainer(context),
          ),
        ],
      ),
  ...
  /// Opens the plain-language metric explainer: what equity and equity loss are,
  /// what error rate means, and the mark thresholds.
  void _showMetricExplainer(BuildContext context) {
    showDialog<void>(
      context: context,
      builder: (context) => const _MetricExplainerDialog(),
    );
  }
...
class _MetricExplainerDialog extends StatelessWidget {
  const _MetricExplainerDialog();
