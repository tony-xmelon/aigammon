...
- **Dart-side Janowski/MET fallback** — only if Task 7 finds wildbg's `cube_info` + away-score config insufficient for the tutor's cube advice; decision recorded in Task 7's report.
