...
class OnlineConfig {
  ...
  /// Emulator port for the Cloud Functions HTTP endpoints.
  ...
  /// Firebase ports (Firestore 8080, Auth 9099, Functions 5001).
  ...
  String get firestoreDocumentsBase {
    ...
    return '$root/projects/$projectId/databases/(default)/documents';
  }
  ...
  /// Base URL for the Cloud Functions HTTP callables (no trailing slash).
  String get functionsBase => isEmulator
